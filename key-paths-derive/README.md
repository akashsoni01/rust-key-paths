...
Inspired by **Swift’s KeyPath / CasePath** system, this feature rich crate lets you work with **struct fields** and **enum variants** as *first-class values*. Use **cargo install cargo-expand** and run **cargo expand --lib > expanded.rs** to see the extracted code.
