...
//!
//! This example shows how to use the chain_arc_mutex and chain_arc_rwlock methods
...
fn main() {
    ...
    // Example 1: Read through Arc<Mutex<T>> with chain_arc_mutex
    ContainerTest::mutex_data_r()
        .chain_arc_mutex(SomeStruct::data_r())
        .get(&container, |value| {
            println!("✅ chain_arc_mutex (read): data = {}", value);
        });
    ...
    ContainerTest::mutex_data_r()
        ...
        .get(&container, |value| {
            println!("✅ chain_arc_mutex_optional (read): optional_field = {}", value);
        });
    ...
    ContainerTest::mutex_data_r()
        ...
        .get_mut(&write_container, |value| {
            *value = "Modified via chain_arc_mutex_writable".to_string();
            println!("✅ chain_arc_mutex_writable (write): Modified data");
        });
    ...
    ContainerTest::mutex_data_r()
        ...
        .get_mut(&write_container, |value| {
            *value = "Modified optional via chain".to_string();
            println!("✅ chain_arc_mutex_writable_optional (write): Modified optional_field");
        });
    ...
    // Example 5: Read through Arc<RwLock<T>> with chain_arc_rwlock
    ContainerTest::rwlock_data_r()
        .chain_arc_rwlock(SomeStruct::data_r())
        .get(&container, |value| {
            println!("✅ chain_arc_rwlock (read): data = {}", value);
        });
    ...
    ContainerTest::rwlock_data_r()
        ...
        .get(&container, |value| {
            println!("✅ chain_arc_rwlock_optional (read): optional_field = {}", value);
        });
    ...
    ContainerTest::rwlock_data_r()
        ...
        .get_mut(&rwlock_write_container, |value| {
            *value = "Modified via chain_arc_rwlock_writable".to_string();
            println!("✅ chain_arc_rwlock_writable (write): Modified data");
        });
    ...
    ContainerTest::rwlock_data_r()
        ...
        .get_mut(&rwlock_write_container, |value| {
            *value = "Modified optional via rwlock chain".to_string();
            println!("✅ chain_arc_rwlock_writable_optional (write): Modified optional_field");
        });
    ...
    println!("  • chain_arc_mutex(inner_keypath) -> read through Arc<Mutex<T>>");
    println!("  • chain_arc_mutex_optional(inner_optional_keypath) -> read optional through Arc<Mutex<T>>");
    println!("  • chain_arc_mutex_writable(inner_writable_keypath) -> write through Arc<Mutex<T>>");
    println!("  • chain_arc_mutex_writable_optional(inner_writable_optional_keypath) -> write optional through Arc<Mutex<T>>");
    println!("  • chain_arc_rwlock(inner_keypath) -> read through Arc<RwLock<T>>");
    println!("  • chain_arc_rwlock_optional(inner_optional_keypath) -> read optional through Arc<RwLock<T>>");
    println!("  • chain_arc_rwlock_writable(inner_writable_keypath) -> write through Arc<RwLock<T>>");
    println!("  • chain_arc_rwlock_writable_optional(inner_writable_optional_keypath) -> write optional through Arc<RwLock<T>>");
