...
mod parking_lot_example {
    use keypaths_proc::{Casepaths, Kp, WritableKp};
    ...
    impl Container {
        ...
        fn parking_mutex_data_r() -> KeyPath<
            Container,
            Arc<ParkingMutex<DataStruct>>,
            impl for<'r> Fn(&'r Container) -> &'r Arc<ParkingMutex<DataStruct>>,
        > {
            keypath!(|c: &Container| &c.parking_mutex_data)
        }

        fn parking_rwlock_data_r() -> KeyPath<
            Container,
            Arc<ParkingRwLock<DataStruct>>,
            impl for<'r> Fn(&'r Container) -> &'r Arc<ParkingRwLock<DataStruct>>,
        > {
            keypath!(|c: &Container| &c.parking_rwlock_data)
        }

        // OptionalKeyPath methods for Option<Arc<parking_lot::*>> fields
        fn optional_mutex_fr() -> OptionalKeyPath<
            Container,
            Arc<ParkingMutex<DataStruct>>,
            impl for<'r> Fn(&'r Container) -> Option<&'r Arc<ParkingMutex<DataStruct>>>,
        > {
            opt_keypath!(|c: &Container| c.optional_mutex.as_ref())
        }

        fn optional_rwlock_fr() -> OptionalKeyPath<
            Container,
            Arc<ParkingRwLock<DataStruct>>,
            impl for<'r> Fn(&'r Container) -> Option<&'r Arc<ParkingRwLock<DataStruct>>>,
        > {
            opt_keypath!(|c: &Container| c.optional_rwlock.as_ref())
        }

        // OptionalKeyPath for enum -> Arc<parking_lot::RwLock<T>> chain
        fn state_fr() -> OptionalKeyPath<
            Container,
            AppState,
            impl for<'r> Fn(&'r Container) -> Option<&'r AppState>,
        > {
    ...
    pub fn run() {
        ...
        Container::parking_mutex_data_r()
            ...
            .get(&container, |value| {
                println!(
                    "✅ then_arc_parking_mutex_optional_at_kp (read): optional_value = {}",
                    value
                );
            });
        ...
        Container::parking_rwlock_data_r()
            ...
            .get(&container, |value| {
                println!(
                    "✅ then_arc_parking_rwlock_optional_at_kp (read): optional_value = {}",
                    value
                );
            });
        ...
        Container::optional_mutex_fr()
            ...
            .get(&container, |value| {
                println!(
                    "✅ optional -> chain_arc_parking_mutex_at_kp (read): name = {}",
                    value
                );
            });
        ...
        Container::optional_mutex_fr()
            ...
            .get_mut(&opt_write_container, |value| {
                *value = "Modified via optional parking_mutex chain".to_string();
                println!(
                    "✅ optional -> chain_arc_parking_mutex_writable_at_kp (write): Modified name"
                );
            });
        ...
        Container::optional_rwlock_fr()
            ...
            .get(&container, |value| {
                println!(
                    "✅ optional -> chain_arc_parking_rwlock_at_kp (read): name = {}",
                    value
                );
            });
        ...
        Container::optional_rwlock_fr()
            ...
            .get_mut(&opt_rwlock_write_container, |value| {
                *value = "Modified via optional parking_rwlock chain".to_string();
                println!(
                    "✅ optional -> chain_arc_parking_rwlock_writable_at_kp (write): Modified name"
                );
            });
        ...
        Container::state_fr()
            ...
            .get(&container, |value| {
                println!(
                    "✅ enum -> chain_arc_parking_rwlock_at_kp (read): user_name = {}",
                    value
                );
            });
        ...
        Container::state_fr()
            ...
            .get_mut(&enum_container, |value| {
                *value = "Bob (Updated via enum chain)".to_string();
                println!(
                    "✅ enum -> chain_arc_parking_rwlock_writable_at_kp (write): Modified user_name"
                );
            });
