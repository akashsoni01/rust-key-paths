...
use rust_keypaths::{KeyPath, keypath, writable_keypath};
use std::sync::Arc;
...
fn main() {
    ...
    crate::Container::parking_mutex_data_r()
        .chain_arc_parking_mutex(crate::DataStruct::name_r())
        .get(&container, |value| {
    ...
    crate::Container::parking_mutex_data_r()
        .chain_arc_parking_mutex_optional(crate::DataStruct::optional_value_fr())
        .get(&container, |value| {
    ...
    crate::Container::parking_mutex_data_r()
        .chain_arc_parking_mutex_writable(crate::DataStruct::name_w())
    ...
    crate::Container::parking_mutex_data_r()
        .chain_arc_parking_mutex_writable_optional(crate::DataStruct::optional_value_fw())
        .get_mut(&write_container, |value| {
    ...
    crate::Container::parking_rwlock_data_r()
        .chain_arc_parking_rwlock(crate::DataStruct::name_r())
        .get(&container, |value| {
    ...
    crate::Container::parking_rwlock_data_r()
        .chain_arc_parking_rwlock_optional(crate::DataStruct::optional_value_fr())
        .get(&container, |value| {
    ...
    crate::Container::parking_rwlock_data_r()
        .chain_arc_parking_rwlock_writable(crate::DataStruct::name_w())
    ...
    crate::Container::parking_rwlock_data_r()
        .chain_arc_parking_rwlock_writable_optional(crate::DataStruct::optional_value_fw())
        .get_mut(&rwlock_write_container, |value| {
