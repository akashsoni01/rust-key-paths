...
fn main() {
    ...
    ContainerTest::mutex_data_r()
        ...
        .get(&container, |value| {
            println!(
                "✅ chain_arc_mutex_optional_at_kp (read): optional_field = {}",
                value
            );
        });
    ...
    ContainerTest::rwlock_data_r()
        ...
        .get(&container, |value| {
            println!(
                "✅ chain_arc_rwlock_optional_at_kp (read): optional_field = {}",
                value
            );
        });
    ...
    ContainerTest::rwlock_data_r()
        ...
        .get_mut(&rwlock_write_container, |value| {
            *value = "Modified optional via rwlock chain".to_string();
            println!(
                "✅ chain_arc_rwlock_writable_optional_at_kp (write): Modified optional_field"
            );
        });
    ...
    println!(
        "  • chain_arc_mutex_optional_at_kp(inner_optional_keypath) -> read optional through Arc<Mutex<T>>"
    );
    println!(
        "  • chain_arc_mutex_writable_at_kp(inner_writable_keypath) -> write through Arc<Mutex<T>>"
    );
    println!(
        "  • chain_arc_mutex_writable_optional_at_kp(inner_writable_optional_keypath) -> write optional through Arc<Mutex<T>>"
    );
    println!("  • chain_arc_rwlock_at_kp(inner_keypath) -> read through Arc<RwLock<T>>");
    println!(
        "  • chain_arc_rwlock_optional_at_kp(inner_optional_keypath) -> read optional through Arc<RwLock<T>>"
    );
    println!(
        "  • chain_arc_rwlock_writable_at_kp(inner_writable_keypath) -> write through Arc<RwLock<T>>"
    );
    println!(
        "  • chain_arc_rwlock_writable_optional_at_kp(inner_writable_optional_keypath) -> write optional through Arc<RwLock<T>>"
    );
