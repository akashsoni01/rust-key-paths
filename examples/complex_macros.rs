...
fn main() {
    ...
    let settings_fw = App::settings();
    let db_fw = Settings::db();
    ...
    let connected_case = Connection::connected_case_r();
    ...
    let st_pending = Status::pending_case_r();
    st = Status::Pending(5);
