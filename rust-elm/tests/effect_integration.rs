...
use rust_elm::{start_runtime, Cmd, Effect, Environment, panic_on_state_clone, Program, Runtime, RuntimeConfig, RunSender};
...
fn cancel_effect_aborts_in_flight_task() {
    ...
    let runtime = start_runtime(Program::new(init, update, subs), Environment::new(), RuntimeConfig::new(16));
    runtime.dispatch(0);
